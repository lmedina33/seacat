...
db.define_table(auth.settings.table_user_name,
                ...
                Field('email', 'string', length=128, required=True, requires=[IS_EMAIL(), IS_NOT_IN_DB(db, 'auth_user.email')], label=T("Email")),
...
db.define_table('personal_data',
                ...
                Field('cuil', 'string', length=11, requires=IS_EMPTY_OR(IS_MATCH('\d{11}')), label="CUIL", comment=T("Insert only numbers")+" i.e.: 20126548971"),
